...
<body>
    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        ...
        <a  class= "nav-link active" arria-current="page" href="create.php">Tambah Mahasiswa</a>
    ...
    <script src ="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta3/dist/js/bootstrap.bundle.min.js" integrity="sha384-JEW9xMcG8R+pH31jmWH6WWP0WintQIMb4s7ZOdauHnUtxwoG2vI5DkLts3qm9Ekf"></script>
</body>
</html>